...
public class LaunchAction extends PdfAction {
    ...
    ///         `/F` entry (matches Aspose, which never returns null here —
    ///         PDFNET\_51091 guarded against a NullReferenceException)
    ...
    ///
    /// @param newWindow`true` to open in a new window

...
public class XForm {
    ...
    /// of `contents`. Mirrors C# `XForm.Contents = …` semantics so
    /// mutations made to the [OperatorCollection] returned by
    /// [#getContents()] can be persisted back to the PdfStream.
    ///

...
public class HtmlSaveOptions {
    ...
    /// The folder path for storing external images when `embedImages` is `false`.
    ...
    ///
    /// @return `true` if fixed layout is enabled
    ...
    ///
    /// @param fixedLayout`true` to enable fixed layout
    ...
    ///
    /// @param splitIntoPages`true` to split into pages
    ...
    ///
    /// @return `true` if images are embedded
    ...
    ///
    /// @param embedImages`true` to embed images
    ...
    /// Used when `embedImages` is `false`.
    ///
    /// @return the image folder path, or `null` if not set

...
///
/// A `Graph` extends [BaseParagraph] so it participates in the page layout
/// system. It contains a [ShapeCollection] of drawing shapes (rectangles, circles,
...
public class Graph extends BaseParagraph {
    ...
    ///
    /// @return `true` if position changes are applied; defaults to `true`
    ...
    ///
    /// @param changePosition`true` to enable position change tracking
    ...
    ///
    /// @return the shape collection; never `null`

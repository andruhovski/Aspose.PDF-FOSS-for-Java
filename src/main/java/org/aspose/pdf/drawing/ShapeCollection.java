...
/// A collection of [Shape] objects with optional bounds checking.
///
/// When the [BoundsCheckMode] is set to
/// [BoundsCheckMode#ThrowExceptionIfDoesNotFit], each shape added to
/// the collection is validated against the container dimensions. If the shape
/// does not fit, a [BoundsOutOfRangeException] is thrown.
///

 ...
 * <p>
 * The rectangle is defined by its lower-left corner ({@code left}, {@code bottom})
 * and its dimensions ({@code width}, {@code height}) in user-space units.
 * An optional {@code roundedCornerRadius} produces rounded corners.
 * </p>
 */

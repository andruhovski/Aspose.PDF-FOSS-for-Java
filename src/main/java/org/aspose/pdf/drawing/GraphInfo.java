...
/// scaling, and skew parameters that control how a [Shape] is rendered
...
public class GraphInfo {
    ...
    /// Creates a new `GraphInfo` with default styling (line width 1.0, no dash, no fill).
    public GraphInfo() {
    ...
    ///
    /// @return the dash array, or `null` for a solid line
    ...
    ///
    /// @param dashArray alternating dash and gap lengths, or `null` for solid
    ...
    ///
    /// @return `true` if the line should be drawn with a doubled style
    ...
    ///
    /// @param doubled`true` to draw a doubled line

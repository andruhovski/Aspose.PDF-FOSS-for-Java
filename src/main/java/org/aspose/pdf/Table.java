 ...
 * <p>
 * A table consists of {@link Rows}, each containing {@link Cells}. Column widths are
...
public class Table extends BaseParagraph {
     ...
     * </p>
     *
     * @return the column widths string, or {@code null} if not set
     */
     ...
     *
     * @return the rows collection; never {@code null}
     */
    public Rows getRows() {
        if (rows == null) {
            rows = new Rows();
     ...
     *
     * @return the default cell border, or {@code null}
     */
     ...
     *
     * @return the table border, or {@code null}
     */
     ...
     *
     * @return the default cell padding, or {@code null}
     */
     ...
     *
     * @return {@code true} if the table can be broken across pages
     */
     ...
     *
     * @param broken {@code true} to allow page breaking
     */
     ...
     * <p>
     * When set to {@link BorderCornerStyle#Round}, the corners of the table border
     * are drawn as rounded arcs using the radius from {@link BorderInfo#getRoundedBorderRadius()}.
     * </p>
     *

 ...
 * Used by {@link TextFragmentAbsorber} to control search behavior.
 * </p>
 */
public class TextSearchOptions {
     ...
     *
     * @return {@code true} if matching is case-sensitive
     */
     ...
     *
     * @return {@code true} if text-related graphics are considered
     */
     ...
     *
     * @param value {@code true} to include text-related graphics
     */
     ...
     *
     * @return {@code true} if page bounds are enforced
     */
     ...
     *
     * @param value {@code true} to enforce page bounds
     */
     ...
     *
     * @return {@code true} if annotation text is included
     */
     ...
     *
     * @param value {@code true} to include annotation text
     */
     ...
     *
     * @return {@code true} if such errors should be ignored
     */
     ...
     *
     * @param value {@code true} to ignore resource font errors
     */
     ...
     *
     * @return {@code true} if font-engine encoding should be used
     */
     ...
     *
     * @param value {@code true} to use font-engine encoding
     */
     ...
     *
     * @return excluded rectangles, or {@code null}
     */
     ...
     *
     * @param excludeRectangles rectangles to exclude, or {@code null}
     */

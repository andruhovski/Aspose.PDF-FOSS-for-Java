...
public final class FontRepository {
    ...
    ///
    /// Returns a [Font] object wrapping the font name.
    ...
    ///
    /// @param fontPath the path to the font file
    /// @param style the font style, or `null` for default
    /// @return a Font loaded from the file
    /// @throws IOException if the file cannot be read
    ...
    /// Mirrors `Aspose.Pdf.Text.FontRepository.OpenFont(Stream, FontTypes)`.
    ///
    /// @param fontStream the font byte stream (fully read by this call)
    /// @param type       the font format ([FontTypes#TTF], `OTF`, `Type1`)

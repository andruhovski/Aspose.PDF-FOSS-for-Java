...
/// This is a simple data class used by [PdfBookmarkEditor] to expose
...
public class Bookmark {
    ...
    ///
    /// @return the bookmark title, or `null` if not set
    ...
    ///
    /// @return the action string, or `null` if not set
    ...
    ///
    /// @return the list of child bookmarks, never `null`
    ...
    ///
    /// @return the explicit destination, or `null` if not set
    ...
    /// Convenience alias for [#setDestination(ExplicitDestination)].
    ///
    ...
    /// Convenience alias for [#getDestination()].
    ///

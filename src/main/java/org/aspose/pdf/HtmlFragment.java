 ...
 * An optional {@link TextState} can be set to control the default text styling.
 * </p>
 */
public class HtmlFragment extends BaseParagraph {
     ...
     *
     * @param htmlText the HTML text content; must not be {@code null}
     * @throws NullPointerException if {@code htmlText} is {@code null}
     */
     ...
     *
     * @param htmlText the HTML text; must not be {@code null}
     * @throws NullPointerException if {@code htmlText} is {@code null}
     */
     ...
     *
     * @return the text state, or {@code null} if not set
     */

...
public class PdfFormatConversionOptions {
    ...
    ///
    /// @param logFileName  the path to the log file (may be `null` to suppress file logging)
    /// @param format       the target PDF format
    /// @param errorAction  the action to take on non-compliant elements
    /// @throws IllegalArgumentException if format or errorAction is `null`
    ...
    ///
    /// @param logStream    the stream to receive the log (may be `null`)
    /// @param format       the target PDF format
    /// @param errorAction  the action to take on non-compliant elements
    /// @throws IllegalArgumentException if format or errorAction is `null`
    ...
    /// Returns the log file name, or `null` if not set.
    ///
    ...
    ///
    /// @param logFileName the log file path, or `null` to disable file logging
    public void setLogFileName(String logFileName) {
        this.logFileName = logFileName;
    }

    /// Returns the log output stream, or `null` if not set.
    ///
    ...
    ///
    /// @param logStream the stream for log output, or `null`
    ...
    ///
    /// @param format the format (must not be `null`)
    ...
    ///
    /// @param errorAction the action (must not be `null`)
    /// @throws IllegalArgumentException if errorAction is `null`
    ...
    ///
    /// @param transparencyAction the action (must not be `null`)
    /// @throws IllegalArgumentException if transparencyAction is `null`
    ...
    ///
    /// @return `true` if fonts will be embedded (default)
    ...
    ///
    /// @return `true` if fonts will be subsetted (default)
    ...
    ///
    /// @param subsetFonts`true` to subset fonts
    ...
    ///
    /// @param defaultFontName the font name (must not be `null`)
    /// @throws IllegalArgumentException if defaultFontName is `null`
    ...
    ///
    /// @return `true` if font errors are ignored
    ...
    ///
    /// @param ignoreResourceFontErrors`true` to ignore font errors
    ...
    ///
    /// @return `true` if text alignment is enabled
    ...
    ///
    /// @param alignText`true` to enable text alignment
    ...
    ///
    /// @param softMaskAction the action (must not be `null`)
    /// @throws IllegalArgumentException if softMaskAction is `null`
    ...
    ///
    /// @param autoTaggingSettings the auto-tagging settings, or `null` to disable

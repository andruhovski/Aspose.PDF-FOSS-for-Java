 ...
 * <p>
 * The matrix is stored as six values {@code [a, b, c, d, e, f]} corresponding to:
 * <pre>
 *   | a  b  0 |
 *   | c  d  0 |
 *   | e  f  1 |
...
public class Matrix {
     ...
     *
     * @param elements the array {@code [a, b, c, d, e, f]}
     ...
     *
     * @return a double array {@code [a, b, c, d, e, f]}
     */
     ...
     * <p>
     * The result represents the combined transformation: first apply {@code this},
     * then apply {@code other}.
     * </p>
     *
     ...
     * @return a double array {@code [newX, newY]} where
     *         {@code newX = a*x + c*y + e} and {@code newY = b*x + d*y + f}
     */
     ...
     * @return the transformed bounding rectangle, or {@code null} if input is null
     */

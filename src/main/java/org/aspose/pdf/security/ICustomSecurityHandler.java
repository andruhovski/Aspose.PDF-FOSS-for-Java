...
public interface ICustomSecurityHandler {
    ...
    /**
     * Returns the handler sub-filter name, or {@code null} if none is needed.
     *
     * @return sub-filter name or {@code null}
     */
    String getSubFilter();
     ...
     * @return encoded permission bytes, or {@code null} when not used
     */

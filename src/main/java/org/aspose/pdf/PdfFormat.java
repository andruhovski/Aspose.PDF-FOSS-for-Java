...
public enum PdfFormat {
    ...
    /**
     * Returns the ISO standard number (e.g. "19005" for PDF/A), or {@code null}
    ...
    /**
     * Returns the conformance level (e.g. "A", "B", "U"), or {@code null}
     * if not applicable.
     *
    ...
    /**
     * Returns {@code true} if this format is any PDF/A variant (ISO 19005).
     *
    ...
    /**
     * Returns {@code true} if this is a PDF/A Level A conformance.
     *
    ...
    /**
     * Returns {@code true} if this is a PDF/A Level U conformance.
     *
    ...
    /**
     * Returns {@code true} if this is a PDF/A-1 variant (part 1).
     *
    ...
    /**
     * Returns {@code true} if this is PDF/A-2 or later (part >= 2).
     *
    ...
    /**
     * Returns {@code true} if this is a PDF/A-3 variant (part 3).
     *
    ...
    /**
     * Returns {@code true} if this is a PDF/A-4 variant (part 4).
     *
    ...
    /**
     * Returns {@code true} if this format is any PDF/X variant (ISO 15930).
     *
    ...
    /**
     * Returns {@code true} if this is PDF/X-1a specifically.
     *
    ...
    /**
     * Returns {@code true} if this is PDF/X-3.
     *
    ...
    /**
     * Returns {@code true} if this is a plain PDF version target (not a standard).
     *

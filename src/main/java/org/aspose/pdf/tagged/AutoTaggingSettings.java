...
public class AutoTaggingSettings {
     ...
     *
     * @return {@code true} if document structure elements will be tagged
     */
     ...
     *
     * @param tagDocumentStructure {@code true} to enable document structure tagging
     */
     ...
     *
     * @return {@code true} if headings will be tagged
     */
     ...
     *
     * @param tagHeadings {@code true} to enable heading tagging
     */
     ...
     *
     * @return {@code true} if tables will be tagged
     */
     ...
     *
     * @param tagTables {@code true} to enable table tagging
     */
     ...
     *
     * @return {@code true} if images will be tagged
     */
     ...
     *
     * @param tagImages {@code true} to enable image tagging
     */
     ...
     *
     * @return {@code true} if links will be tagged
     */
     ...
     *
     * @param tagLinks {@code true} to enable link tagging
     */

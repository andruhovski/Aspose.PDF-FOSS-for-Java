 ...
 *
 * <p>Controls the placement and layout of tagged elements within
 * the document's visual presentation.</p>
 */
public class PositionSettings {
     ...
     *
     * @return the horizontal alignment, or {@code null}
     */
     ...
     *
     * @return the vertical alignment, or {@code null}
     */
     ...
     *
     * @return {@code true} if first paragraph in column
     */
     ...
     *
     * @param firstParagraphInColumn {@code true} to start in new column
     */
     ...
     *
     * @param inLineParagraph {@code true} for inline
     */
     ...
     *
     * @return {@code true} if in new page
     */
     ...
     *
     * @param inNewPage {@code true} to force new page
     */
     ...
     *
     * @return {@code true} if kept with next
     */
     ...
     *
     * @param keptWithNext {@code true} to keep with next
     */
     ...
     * Returns the margin.
     *
     * @return the margin info, or {@code null}
     */

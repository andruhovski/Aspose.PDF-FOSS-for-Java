 ...
 *
 * <p>Provides factory methods for creating typed structure elements
 * and document-level metadata accessors for title and language.</p>
 *
 * <p>Usage example:</p>
 * <pre>
...
public interface ITaggedContent {
     ...
     *
     * @return the root element, or {@code null} if no structure tree exists
     */

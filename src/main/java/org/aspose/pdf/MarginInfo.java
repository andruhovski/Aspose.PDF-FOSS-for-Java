...
///
/// **Constructor argument order: (left, bottom, right, top)** —
/// this matches Aspose .NET's `MarginInfo(double, double, double, double)`.
/// Note that this is _not_ the same order as the (now-deprecated) nested
/// `PageInfo.MarginInfo(top, bottom, left, right)`. Example:
///
/// ```
...
/// ```
///
/// If you only need uniform margins, use [#MarginInfo(double)].

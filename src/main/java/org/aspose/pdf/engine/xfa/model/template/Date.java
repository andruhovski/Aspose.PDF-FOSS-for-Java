...
/**
 * Typed XFA template element <code>date</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Date extends XfaNode {

    /** Wraps a backing <code>date</code> element. */
    public Date(Element element, XfaNode parent) {

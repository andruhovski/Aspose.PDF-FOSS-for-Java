...
/**
 * Typed XFA template element <code>decimal</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Decimal extends XfaNode {

    /** Wraps a backing <code>decimal</code> element. */
    public Decimal(Element element, XfaNode parent) {
        super(element, parent);
    }

    /** @return the typed <code>fracDigits</code> attribute, or null. */
    public java.lang.Integer getFracDigits() { return getInteger("fracDigits"); }
    /** Sets the <code>fracDigits</code> attribute. */
    ...
    /** @return the typed <code>leadDigits</code> attribute, or null. */
    public java.lang.Integer getLeadDigits() { return getInteger("leadDigits"); }
    /** Sets the <code>leadDigits</code> attribute. */

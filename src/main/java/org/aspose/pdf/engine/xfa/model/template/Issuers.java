...
/**
 * Typed XFA template element <code>issuers</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Issuers extends XfaNode {

    /** Wraps a backing <code>issuers</code> element. */
    public Issuers(Element element, XfaNode parent) {

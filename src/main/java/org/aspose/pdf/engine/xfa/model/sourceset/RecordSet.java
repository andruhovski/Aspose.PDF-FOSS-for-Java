...
/**
 * Typed XFA template element <code>recordSet</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class RecordSet extends XfaNode {

    /** Wraps a backing <code>recordSet</code> element. */
    public RecordSet(Element element, XfaNode parent) {
        super(element, parent);
    }

    /** Allowed values of the <code>bofAction</code> attribute. */
    ...
    /** @return the typed <code>cursorLocation</code> attribute, or null. */
    ...
    /** Allowed values of the <code>lockType</code> attribute. */

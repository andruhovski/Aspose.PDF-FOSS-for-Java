...
/**
 * Typed XFA template element <code>wsdlAddress</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class WsdlAddress extends XfaNode {

    /** Wraps a backing <code>wsdlAddress</code> element. */
    public WsdlAddress(Element element, XfaNode parent) {

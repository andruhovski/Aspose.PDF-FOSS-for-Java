...
/**
 * Typed XFA template element <code>boolean</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Boolean extends XfaNode {

    /** Wraps a backing <code>boolean</code> element. */
    public Boolean(Element element, XfaNode parent) {

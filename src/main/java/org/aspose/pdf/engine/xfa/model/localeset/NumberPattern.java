...
/**
 * Typed XFA template element <code>numberPattern</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class NumberPattern extends XfaNode {

    /** Wraps a backing <code>numberPattern</code> element. */
    public NumberPattern(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>time</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Time extends XfaNode {

    /** Wraps a backing <code>time</code> element. */
    public Time(Element element, XfaNode parent) {

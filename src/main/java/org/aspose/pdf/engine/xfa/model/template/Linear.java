...
/**
 * Typed XFA template element <code>linear</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Linear extends XfaNode {

    /** Wraps a backing <code>linear</code> element. */
    public Linear(Element element, XfaNode parent) {

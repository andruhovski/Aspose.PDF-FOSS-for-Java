...
/**
 * Typed XFA template element <code>rootElement</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class RootElement extends XfaNode {

    /** Wraps a backing <code>rootElement</code> element. */
    public RootElement(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>signing</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Signing extends XfaNode {

    /** Wraps a backing <code>signing</code> element. */
    public Signing(Element element, XfaNode parent) {

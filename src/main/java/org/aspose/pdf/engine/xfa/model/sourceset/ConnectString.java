...
/**
 * Typed XFA template element <code>connectString</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class ConnectString extends XfaNode {

    /** Wraps a backing <code>connectString</code> element. */
    public ConnectString(Element element, XfaNode parent) {

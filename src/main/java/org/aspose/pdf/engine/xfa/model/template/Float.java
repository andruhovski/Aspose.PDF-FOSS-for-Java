...
/**
 * Typed XFA template element <code>float</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Float extends XfaNode {

    /** Wraps a backing <code>float</code> element. */
    public Float(Element element, XfaNode parent) {

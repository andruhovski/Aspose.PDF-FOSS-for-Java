...
/**
 * Base of the typed XFA template model. Each {@code XfaNode} is a typed view
 * over a backing {@link org.w3c.dom.Element}; typed getters/setters read and
 * write attributes and child elements directly on that Element.
 *
 * <p>Because the DOM is the backing store, round-trip is inherent: free child
 ...
 * from the XFA template model) add element-specific accessors.</p>
 */
public class XfaNode {
    ...
    /** Parent node, or {@code null} for the root of a loaded tree. */
    protected XfaNode parent;

    /**
     * Creates a node over a backing element.
     *
     * @param element backing DOM element (must not be {@code null})
    ...
    /** @return the element's namespace URI ({@code null} if none). */
     ...
     * @return the value, or {@code null} if the attribute is absent
     */
    ...
    /**
     * Sets or removes an attribute. A {@code null} value removes it.
     *
     * @param name  attribute name
     * @param value new value, or {@code null} to remove
     */
    ...
    /** @return the attribute as a string (alias of {@link #getAttribute}). */
     ...
     *
     * @param name attribute name
     * @return boxed integer, or {@code null} if absent/unparseable
     */
    ...
    /**
     * The attribute parsed as an XFA boolean ({@code "1"}/{@code "true"} =&gt;
     * true, {@code "0"}/{@code "false"} =&gt; false).
     *
     * @param name attribute name
     * @return boxed boolean, or {@code null} if absent/unrecognised
     */
    ...
    /**
     * The attribute parsed as an {@link XfaMeasurement}.
     *
     * @param name attribute name
     * @return the measurement, or {@code null} if absent/invalid
     */
    public XfaMeasurement getMeasurement(String name) {
        return XfaMeasurement.parse(getAttribute(name));
    }

    /** Sets a measurement attribute (removes it when {@code m} is null). */
    ...
    /** @return the {@code id} attribute, or {@code null}. */
    public String getId() {
        return getAttribute("id");
    }

    /** @return the {@code name} attribute, or {@code null}. */
    public String getName() {
        return getAttribute("name");
    }

    /** @return the {@code use} reference (intra-document prototype id), or {@code null}. */
    public String getUse() {
        return getAttribute("use");
    }

    /** @return the {@code usehref} reference (prototype href), or {@code null}. */
     ...
     * @return the typed child, or {@code null} if none
     */

...
/// Typed XFA template element `image`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class Image extends XfaNode {

    /// Wraps a backing `image` element.
    public Image(Element element, XfaNode parent) {
        super(element, parent);
    }

    /// Allowed values of the `aspect` attribute.
    ...
    /// @return the typed `aspect` attribute, or null.
    ...
    /// @return the raw `aspect` string, or null.

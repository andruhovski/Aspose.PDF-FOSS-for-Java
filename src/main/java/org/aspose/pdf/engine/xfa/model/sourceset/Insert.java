...
/**
 * Typed XFA template element <code>insert</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Insert extends XfaNode {

    /** Wraps a backing <code>insert</code> element. */
    public Insert(Element element, XfaNode parent) {

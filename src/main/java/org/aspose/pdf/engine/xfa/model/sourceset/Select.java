...
/**
 * Typed XFA template element <code>select</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Select extends XfaNode {

    /** Wraps a backing <code>select</code> element. */
    public Select(Element element, XfaNode parent) {

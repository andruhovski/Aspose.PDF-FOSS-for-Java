...
/**
 * Typed XFA template element <code>certificate</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Certificate extends XfaNode {

    /** Wraps a backing <code>certificate</code> element. */
    public Certificate(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>appearanceFilter</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class AppearanceFilter extends XfaNode {

    /** Wraps a backing <code>appearanceFilter</code> element. */
    public AppearanceFilter(Element element, XfaNode parent) {

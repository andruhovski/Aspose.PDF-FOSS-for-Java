...
/**
 * A typed accessor for one attribute of an {@link XfaNode}, backed by a
 ...
 * or a generated enum). Reading an absent attribute yields {@code null}.
 *
...
public final class XfaAttribute<T> {
    ...
    public interface Codec<T> {
        /** Decodes the raw string ({@code null}-safe at the call site). */
        T decode(String raw);
    ...
    /** Codec for XFA boolean attributes ({@code 0/1} or {@code true/false}). */
    ...
    /** @return the decoded value, or {@code null} if the attribute is absent. */
    public T get() {
    ...
    /**
     * Sets the value (removes the attribute when {@code value} is null).
     *
    ...
    /** @return the raw attribute string, or {@code null}. */

...
/**
 * Typed XFA template element <code>dayNames</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class DayNames extends XfaNode {

    /** Wraps a backing <code>dayNames</code> element. */
    ...
    /** @return the <code>day</code> child (typed), or null. */
    public Day getDay() { return (Day) getChild("day"); }
    /** Ensures and returns the <code>day</code> child. */

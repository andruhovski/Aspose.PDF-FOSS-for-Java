...
/**
 * Typed XFA template element <code>update</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Update extends XfaNode {

    /** Wraps a backing <code>update</code> element. */
    public Update(Element element, XfaNode parent) {

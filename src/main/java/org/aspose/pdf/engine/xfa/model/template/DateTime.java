...
/**
 * Typed XFA template element <code>dateTime</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class DateTime extends XfaNode {

    /** Wraps a backing <code>dateTime</code> element. */
    public DateTime(Element element, XfaNode parent) {

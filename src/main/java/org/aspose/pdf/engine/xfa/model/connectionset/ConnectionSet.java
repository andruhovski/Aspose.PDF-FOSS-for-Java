...
/// Typed XFA template element `connectionSet`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class ConnectionSet extends XfaNode {

    /// Wraps a backing `connectionSet` element.
    public ConnectionSet(Element element, XfaNode parent) {
        super(element, parent);
    }

    /// @return the `wsdlConnection` children (typed).
    ...
    /// Appends a new `xsdConnection` child.

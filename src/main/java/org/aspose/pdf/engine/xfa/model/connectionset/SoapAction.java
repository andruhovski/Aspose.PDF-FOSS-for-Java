...
/**
 * Typed XFA template element <code>soapAction</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class SoapAction extends XfaNode {

    /** Wraps a backing <code>soapAction</code> element. */
    public SoapAction(Element element, XfaNode parent) {

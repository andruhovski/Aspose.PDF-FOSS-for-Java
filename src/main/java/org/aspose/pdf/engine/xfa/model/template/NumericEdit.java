...
/**
 * Typed XFA template element <code>numericEdit</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class NumericEdit extends XfaNode {

    /** Wraps a backing <code>numericEdit</code> element. */
    public NumericEdit(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>reasons</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Reasons extends XfaNode {

    /** Wraps a backing <code>reasons</code> element. */
    public Reasons(Element element, XfaNode parent) {

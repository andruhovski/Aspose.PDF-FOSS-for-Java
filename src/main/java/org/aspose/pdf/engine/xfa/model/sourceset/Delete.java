...
/**
 * Typed XFA template element <code>delete</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Delete extends XfaNode {

    /** Wraps a backing <code>delete</code> element. */
    public Delete(Element element, XfaNode parent) {

...
/// Typed XFA template element `exObject`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class ExObject extends XfaNode {

    /// Wraps a backing `exObject` element.
    public ExObject(Element element, XfaNode parent) {
        super(element, parent);
    }

    /// @return the typed `archive` attribute, or null.
    ...
    /// @return the typed `classId` attribute, or null.
    ...
    /// @return the typed `codeBase` attribute, or null.
    ...
    /// @return the typed `codeType` attribute, or null.

...
/**
 * Typed XFA template element <code>exObject</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class ExObject extends XfaNode {

    /** Wraps a backing <code>exObject</code> element. */
    public ExObject(Element element, XfaNode parent) {
        super(element, parent);
    }

    /** @return the typed <code>archive</code> attribute, or null. */
    public String getArchive() { return getString("archive"); }
    /** Sets the <code>archive</code> attribute. */
    public void setArchive(String value) { setAttribute("archive", value); }

    /** @return the typed <code>classId</code> attribute, or null. */
    public String getClassId() { return getString("classId"); }
    /** Sets the <code>classId</code> attribute. */
    public void setClassId(String value) { setAttribute("classId", value); }

    /** @return the typed <code>codeBase</code> attribute, or null. */
    public String getCodeBase() { return getString("codeBase"); }
    /** Sets the <code>codeBase</code> attribute. */
    public void setCodeBase(String value) { setAttribute("codeBase", value); }

    /** @return the typed <code>codeType</code> attribute, or null. */
    public String getCodeType() { return getString("codeType"); }
    /** Sets the <code>codeType</code> attribute. */
    public void setCodeType(String value) { setAttribute("codeType", value); }

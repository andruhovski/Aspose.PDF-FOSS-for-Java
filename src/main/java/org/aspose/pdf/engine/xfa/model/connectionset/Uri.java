...
/**
 * Typed XFA template element <code>uri</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Uri extends XfaNode {

    /** Wraps a backing <code>uri</code> element. */
    public Uri(Element element, XfaNode parent) {

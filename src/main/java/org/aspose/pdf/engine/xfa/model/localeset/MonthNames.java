...
/// Typed XFA template element `monthNames`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class MonthNames extends XfaNode {

    /// Wraps a backing `monthNames` element.
    ...
    /// @return the `month` child (typed), or null.
    public Month getMonth() { return (Month) getChild("month"); }
    /// Ensures and returns the `month` child.

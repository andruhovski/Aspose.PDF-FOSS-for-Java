...
/**
 * Typed XFA template element <code>oid</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Oid extends XfaNode {

    /** Wraps a backing <code>oid</code> element. */
    public Oid(Element element, XfaNode parent) {

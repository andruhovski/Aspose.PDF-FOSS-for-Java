...
/// Typed XFA template element `comb`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class Comb extends XfaNode {

    /// Wraps a backing `comb` element.
    ...
    /// @return the typed `numberOfCells` attribute, or null.
    public java.lang.Integer getNumberOfCells() { return getInteger("numberOfCells"); }
    /// Sets the `numberOfCells` attribute.

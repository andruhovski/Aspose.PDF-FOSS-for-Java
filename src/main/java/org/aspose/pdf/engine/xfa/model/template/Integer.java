...
/**
 * Typed XFA template element <code>integer</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Integer extends XfaNode {

    /** Wraps a backing <code>integer</code> element. */
    public Integer(Element element, XfaNode parent) {

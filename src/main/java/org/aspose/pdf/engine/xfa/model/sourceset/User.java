...
/**
 * Typed XFA template element <code>user</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class User extends XfaNode {

    /** Wraps a backing <code>user</code> element. */
    public User(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>localeSet</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class LocaleSet extends XfaNode {

    /** Wraps a backing <code>localeSet</code> element. */
    public LocaleSet(Element element, XfaNode parent) {
        super(element, parent);
    }

    /** @return the <code>locale</code> children (typed). */
    ...
    /** Appends a new <code>locale</code> child. */

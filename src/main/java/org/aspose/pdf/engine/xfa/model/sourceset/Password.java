...
/**
 * Typed XFA template element <code>password</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Password extends XfaNode {

    /** Wraps a backing <code>password</code> element. */
    public Password(Element element, XfaNode parent) {

...
/**
 * Typed XFA template element <code>soapAddress</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class SoapAddress extends XfaNode {

    /** Wraps a backing <code>soapAddress</code> element. */
    public SoapAddress(Element element, XfaNode parent) {

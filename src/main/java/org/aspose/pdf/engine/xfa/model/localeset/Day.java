...
/**
 * Typed XFA template element <code>day</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Day extends XfaNode {

    /** Wraps a backing <code>day</code> element. */
    public Day(Element element, XfaNode parent) {

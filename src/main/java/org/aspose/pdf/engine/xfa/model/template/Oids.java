...
/**
 * Typed XFA template element <code>oids</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Oids extends XfaNode {

    /** Wraps a backing <code>oids</code> element. */
    public Oids(Element element, XfaNode parent) {

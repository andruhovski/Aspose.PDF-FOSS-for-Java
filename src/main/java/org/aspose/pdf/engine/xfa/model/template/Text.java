...
/// Typed XFA template element `text`. Attribute and child
/// accessors are typed; unknown attributes/children round-trip via the DOM.
public final class Text extends XfaNode {

    /// Wraps a backing `text` element.
    ...
    /// @return the typed `maxChars` attribute, or null.
    public java.lang.Integer getMaxChars() { return getInteger("maxChars"); }
    /// Sets the `maxChars` attribute.
    public void setMaxChars(java.lang.Integer value) { setAttribute("maxChars", value == null ? null : value.toString()); }

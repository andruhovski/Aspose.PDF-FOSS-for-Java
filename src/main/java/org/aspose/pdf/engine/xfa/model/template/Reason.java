...
/**
 * Typed XFA template element <code>reason</code>. Attribute and child
 * accessors are typed; unknown attributes/children round-trip via the DOM.
 */
public final class Reason extends XfaNode {

    /** Wraps a backing <code>reason</code> element. */
    public Reason(Element element, XfaNode parent) {

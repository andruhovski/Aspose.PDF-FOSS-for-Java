 ...
 *
 * <p>Three types of entries exist:</p>
 * <ul>
 *   <li>{@link Type#FREE} — the object has been deleted</li>
 *   <li>{@link Type#IN_USE} — the object exists at a byte offset in the file</li>
 *   <li>{@link Type#COMPRESSED} — the object is stored inside an object stream</li>
 * </ul>
 */
public final class XRefEntry {
    ...
    /** Returns the byte offset for IN_USE entries. */

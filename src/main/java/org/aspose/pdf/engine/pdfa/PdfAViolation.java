...
public final class PdfAViolation {
    ...
    /// @throws IllegalArgumentException if ruleId, severity, or message is `null`
    ...
    /// Returns the PDF object path where the violation was detected, or `null`.
    ///
    ...
    /// Returns the ISO clause reference, or `null`.
    ///
    /// @return the clause

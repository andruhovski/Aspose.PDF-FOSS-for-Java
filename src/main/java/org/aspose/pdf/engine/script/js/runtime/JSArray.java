 ...
 *
 * <p>Maintains the special {@code length} invariant: assigning to an array
 * index &ge; length grows length; assigning a smaller {@code length} deletes
 * the out-of-range indexed elements.</p>
 */
public final class JSArray extends JSObject {
     ...
     *
     * @param arrayPrototype {@code Array.prototype}
     */
    ...
    /**
     * Returns the array-index numeric value of a property name, or {@code -1}

...
/**
 * A single lexical token produced by {@link Lexer}.
 *
 * <p>Immutable value holder. For {@link TokenType#STRING} the {@link #value}
 * field holds the decoded string; for {@link TokenType#NUMBER} the numeric
 * value is in {@link #number} (and {@link #value} holds the raw source); for
 * {@link TokenType#REGEXP} {@link #value} holds the pattern body and
 * {@link #regexFlags} the flag characters.</p>
 */
public final class Token {
    ...
    /** Numeric value for {@link TokenType#NUMBER}; otherwise {@code 0}. */
    public final double number;
    /** Flag characters for {@link TokenType#REGEXP}; otherwise {@code null}. */
    ...
    /** {@code true} if a line terminator occurred between the previous token and this one (drives ASI). */
     ...
     * @param regexFlags    regex flags (for REGEXP tokens) or {@code null}

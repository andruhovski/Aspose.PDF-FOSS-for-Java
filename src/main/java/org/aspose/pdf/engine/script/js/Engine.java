 ...
 *
 * <p>An {@code Engine} owns one {@link Realm} (global object + intrinsics) and
 * an {@link Interpreter}. It is the only type external callers need; the
 ...
 * global object via {@link #getGlobalObject()} &mdash; this build injects
 * nothing, keeping the seam open with no PDF coupling.</p>
 *
 * <pre>{@code

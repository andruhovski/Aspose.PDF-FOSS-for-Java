...
///
/// References an object by its number and generation. Written as `N G R`
/// (e.g., `12 0 R`). Supports lazy resolution: the actual object is loaded
/// on first access via an [ObjectResolver].
///
public final class PdfObjectReference extends PdfBase {
    ...
    /// If the resolver returns null, [PdfNull#INSTANCE] is returned.
    ///

 ...
 *   <li>Visitor pattern via {@link #accept(IPdfVisitor)}</li>
 * </ul>
 */
public abstract class PdfBase {
     ...
     * broken by writing object references in {@code PdfDictionary.writeTo} and
     * {@code PdfArray.writeTo}; this guard covers the remaining case.
     */
     ...
     * a successful enter with a matching {@link #leaveWriting(PdfBase)} in a

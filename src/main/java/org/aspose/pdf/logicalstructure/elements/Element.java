...
///
/// Each concrete subclass wraps a [StructureElement] and provides
/// convenience methods specific to that element type.
public abstract class Element {
    ...
    ///
    /// @return the alternate description, or `null`
    ...
    /// Alias for [#setAlternateDescription(String)].
    ///
    ...
    /// Alias for [#getAlternateDescription()].
    ///
    /// @return the alternative text, or `null`
    ...
    ///
    /// @return the position settings, or `null`

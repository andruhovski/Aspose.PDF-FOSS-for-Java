 ...
 *
 * <p>These properties control the visual presentation of text associated
 * with a structure element. When the document is rendered, the text state
 * is applied to all marked content sequences belonging to the element.</p>
 */
public class StructureTextState {
     ...
     * Returns the font.
     *
     * @return the font, or {@code null} if not set
     */
    public Font getFont() {
        return font;
    }
     ...
     *
     * @return the font size, or {@code null} if not set
     */
     ...
     *
     * @return the font style (combination of {@link FontStyles} flags)
     */
     ...
     *
     * @param fontStyle combination of {@link FontStyles} flags
     */
     ...
     *
     * @return the foreground color, or {@code null} if not set
     */
     ...
     *
     * @return the character spacing, or {@code null} if not set
     */
     ...
     *
     * @return the word spacing, or {@code null} if not set
     */
     ...
     *
     * @return the line spacing, or {@code null} if not set
     */
     ...
     *
     * @return the horizontal scaling (100 = normal), or {@code null} if not set
     */
     ...
     *
     * @return {@code true} if strikeout is enabled
     */
     ...
     *
     * @param strikeOut {@code true} to enable strikeout
     */
     ...
     *
     * @return {@code true} if underline is enabled
     */
     ...
     *
     * @param underline {@code true} to enable underline
     */
     ...
     *
     * @return {@code true} if subscript is enabled
     */
     ...
     *
     * @param subscript {@code true} to enable subscript
     */
     ...
     *
     * @return {@code true} if superscript is enabled
     */
     ...
     *
     * @param superscript {@code true} to enable superscript
     */

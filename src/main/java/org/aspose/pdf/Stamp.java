...
///
/// Subclasses must implement [#put(Page)] to perform the actual rendering.
///
/// @see TextStamp
/// @see ImageStamp
/// @see PdfPageStamp
...
public abstract class Stamp {
    ...
    /// Sets the rotation using the [Rotation] enum.
    ...
    /// Also updates the [Rotation] enum property if the angle matches

 ...
 * {@link ImagePlacement}, which represents an already-placed image extracted from
 * an existing PDF.
 * </p>
 */
public class Image extends BaseParagraph {
     ...
     *
     * @return the file path, or {@code null} if the image is provided via stream
     */
     ...
     *
     * @return the image stream, or {@code null} if the image is provided via file path
     */
     ...
     *
     * @return the image type, or {@code null} if auto-detected
     */
